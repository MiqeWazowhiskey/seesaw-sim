...
- **Weight Movements:** I initially appended the weights as children of the playground, which caused misalignment issues, so in the subsequent step, after the drop animation, I appended them as children of the board to ensure they move together with it. 
